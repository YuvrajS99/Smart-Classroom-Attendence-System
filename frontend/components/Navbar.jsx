...
import { Menu, LogOut, Info, Rocket } from 'lucide-react';
...
const Navbar = ({ onMenuClick }) => {
  ...
  return (
    <div className="flex items-center justify-between bg-white text-gray-800 border-b border-gray-100 px-6 py-4 sticky top-0 z-40 shadow-sm transition-all">
      ...
      {admin ? (
        <div className="flex items-center space-x-6">
          <div className="hidden lg:flex items-center space-x-6 mr-4 border-r border-gray-200 pr-6">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                href={link.path}
