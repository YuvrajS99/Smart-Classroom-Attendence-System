  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Classroom Capture</h1>
        <p className="text-gray-500 mt-1">AI-powered facial detection to count students.</p>
      </div>

      <div className="flex flex-col lg:flex-row gap-6">
        {/* WEBCAM SECTION BOUNDS */}
        <div className="w-full max-w-xl mx-auto lg:mx-0 flex-1 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden relative">
          {!modelsLoaded && (
          ...
          <div className="p-4 sm:p-6 bg-gray-50 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4">
            <button
              onClick={captureAndDetect}
              disabled={!modelsLoaded || isCapturing}
              className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-medium transition-colors disabled:opacity-50"
            >
            ...
            {error && (
              <div className="text-red-500 font-medium text-center sm:text-right">{error}</div>
            )}
          </div>
        </div>
