            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-white sticky top-0 z-10 shadow-sm">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Detected Students</th>
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Cloudinary Asset</th>
                </tr>
              </thead>
                  ...
                  <tr key={capture._id} className="hover:bg-blue-50/50 transition-colors group">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                      <div className="flex items-center font-medium">
                        ...
                        {formatDate(capture.timestamp, true)}
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <a href={capture.imageURL} target="_blank" rel="noreferrer" className="block relative focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg w-fit">
                          <img 
